    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select name="role" id="role" class="block mt-1 w-full" required>
                ...
                <option value="landlord" {{ old('role', $user->role) === 'landlord' ? 'selected' : '' }}>landlord
                </option>
        ...
        <div>
            ...
            <x-text-input id="id_card" name="id_card" type="text" class="mt-1 block w-full" :value="old('id_card', $user->id_card)"
